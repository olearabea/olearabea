...
<li class="breadcrumb-item"><a href="pass.php">Visitors</a>
</li>
</ul>
</div>
</div>
...
?>
<h5 align="center" style="color:blue">Visitors Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
...
<?php 
    ...
    $sql="SELECT * from tblpass where date(updated_on) between '$fdate' and '$tdate'";
